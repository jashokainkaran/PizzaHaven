...
<header class="bg-primary text-gray-100 p-4">
  <div class="w-full flex flex-wrap items-center justify-between mx-auto">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <nav class="flex flex-col items-center text-center md:flex-row md:items-center md:space-x-6 space-y-4 md:space-y-0 w-full">
        <a href="../public/index.php" class="hover:text-accent">Home</a>
        <a href="../public/pizza.php" class="hover:text-accent">Pizzas</a>
        <a href="../public/drinks.php" class="hover:text-accent">Drinks</a>
        <a href="../public/cart.php"><svg class="w-6 h-6 text-gray-800 dark:text-white hover:text-accent" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  <path fill-rule="evenodd" d="M4 4a1 1 0 0 1 1-1h1.5a1 1 0 0 1 .979.796L7.939 6H19a1 1 0 0 1 .979 1.204l-1.25 6a1 1 0 0 1-.979.796H9.605l.208 1H17a3 3 0 1 1-2.83 2h-2.34a3 3 0 1 1-4.009-1.76L5.686 5H5a1 1 0 0 1-1-1Z" clip-rule="evenodd"/>
        ...
        <?php else: ?>
          <a href="../public/login_form.php" class="text-gray-100 hover:text-accent">
            <button class="px-4 py-2 bg-accent text-white rounded-md">Login</button>
          </a>
          <a href="../public/signup_form.php" class="text-gray-100 hover:text-accent">
